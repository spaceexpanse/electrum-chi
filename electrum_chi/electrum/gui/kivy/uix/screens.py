...
Builder.load_file('electrum_chi/electrum/gui/kivy/uix/ui_screens/history.kv')
Builder.load_file('electrum_chi/electrum/gui/kivy/uix/ui_screens/send.kv')
Builder.load_file('electrum_chi/electrum/gui/kivy/uix/ui_screens/receive.kv')
...
class HistoryScreen(CScreen):
    ...
    def get_card(self, tx_item): #tx_hash, tx_mined_status, value, balance):
        ...
        if is_lightning:
            ...
            icon = "atlas://electrum_chi/electrum/gui/kivy/theming/light/lightning"
            ...
            icon = "atlas://electrum_chi/electrum/gui/kivy/theming/light/" + TX_ICONS[status]
...
class SendScreen(CScreen):
    ...
    def read_invoice(self):
        ...
        if not address:
            self.app.show_error(_('Recipient not specified.') + ' ' + _('Please scan an address or a payment request'))
            return
        if not self.amount:
