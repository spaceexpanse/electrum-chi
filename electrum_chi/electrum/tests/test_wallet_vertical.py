...
class TestWalletSending(TestCaseForTestnet):
    ...
    def _bump_fee_p2pkh_when_there_is_a_change_address(self, *, simulate_moving_txs, config):
        ...
        # create tx
        outputs = [PartialTxOutput.from_address_and_value(frombtc('2N1VTMMFb91SH9SNRAkT7z8otP5eZEct4KL'), 2500000)]
    ...
    def _bump_fee_when_user_sends_max(self, *, simulate_moving_txs, config):
        ...
        # create tx
        outputs = [PartialTxOutput.from_address_and_value(frombtc('2N1VTMMFb91SH9SNRAkT7z8otP5eZEct4KL'), '!')]
        coins = wallet.get_spendable_coins(domain=None)
        tx = wallet.make_unsigned_transaction(coins=coins, outputs=outputs, fee=5000)
        tx.set_rbf(True)
        tx.locktime = 1325499
    ...
    def _rbf_batching(self, *, simulate_moving_txs, config):
        ...
        # create tx
        outputs = [PartialTxOutput.from_address_and_value(frombtc('2N1VTMMFb91SH9SNRAkT7z8otP5eZEct4KL'), 2_500_000)]
        coins = wallet.get_spendable_coins(domain=None)
        tx = wallet.make_unsigned_transaction(coins=coins, outputs=outputs, fee=5000)
        tx.set_rbf(True)
        tx.locktime = 1325499
        ...
        outputs = [PartialTxOutput.from_address_and_value(frombtc('2NCVwbmEpvaXKHpXUGJfJr9iB5vtRN3vcut'), 6_000_000)]
        coins = wallet.get_spendable_coins(domain=None)
...
class TestWalletOfflineSigning(TestCaseForTestnet):
    ...
    def test_sending_offline_hd_multisig_online_addr_p2sh(self, mock_save_db):
        ...
        # create unsigned tx
        outputs = [PartialTxOutput.from_address_and_value(frombtc('2MuCQQHJNnrXzQzuqfUCfAwAjPqpyEHbgue'), 2500000)]
        tx = wallet_online.mktx(outputs=outputs, password=None, fee=5000)
        tx.set_rbf(True)
        tx.locktime = 1325503
        tx.version = 1
    ...
    def test_sending_offline_hd_multisig_online_addr_p2wsh_p2sh(self, mock_save_db):
        ...
        # create unsigned tx
        outputs = [PartialTxOutput.from_address_and_value(frombtc('2N8CtJRwxb2GCaiWWdSHLZHHLoZy53CCyxf'), 2500000)]
        tx = wallet_online.mktx(outputs=outputs, password=None, fee=5000)
        tx.set_rbf(True)
        tx.locktime = 1325504
        tx.version = 1
    ...
    def test_sending_offline_hd_multisig_online_addr_p2wsh(self, mock_save_db):
        ...
        # create unsigned tx
        outputs = [PartialTxOutput.from_address_and_value(frombtc('2MyoZVy8T1t94yLmyKu8DP1SmbWvnxbkwRA'), 2500000)]
        tx = wallet_online.mktx(outputs=outputs, password=None, fee=5000)
        tx.set_rbf(True)
        tx.locktime = 1325505
        tx.version = 1
